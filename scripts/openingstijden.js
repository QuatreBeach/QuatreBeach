...
document.getElementById("maand2").textContent = `Bekijk onze evenementen in ${monthName}`;
document.getElementById("maand3").textContent = `Eerstvolgende in ${monthName}`;
...
document.getElementById('open-tekst2').textContent = getOpeningHours();
